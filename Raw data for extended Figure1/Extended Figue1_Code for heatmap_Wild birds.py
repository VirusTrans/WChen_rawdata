...
# 文件路径
file_path = os.path.expanduser("~/桌面/CW/H9/wild birds.xlsx")
...
plt.title("Nucleotide Similarity Heatmap (wild birds)", fontsize=16)

# 保存热图到 ~/桌面/CW/H9/
output_dir = os.path.expanduser("~/桌面/CW/H9/")
os.makedirs(output_dir, exist_ok=True)
output_file = os.path.join(output_dir, "wild birds.png")
